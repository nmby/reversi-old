...
public class LeagueResult implements Result<League> {
    ...
    /** ペアごとの対戦成績が格納された {@code Map}（{@code Pair#idxA} から見た成績） */
    ...
    private LeagueResult(LeagueCondition leagueCondition, Map<Pair, MatchResult> matchResults) {
        ...
        // これ以降、表示用文字列の組み立て。
        // ↓↓↓ 文字列イメージ ↓↓↓
        // [1] xyz.hotchpotch.reversi.aiplayers.SimplestAIPlayer
        // [2] xyz.hotchpotch.reversi.aiplayers.RandomAIPlayer
        // [3] xyz.hotchpotch.reversi.aiplayers.DepthFirstAIPlayer
        // 
        // ＜対戦成績（勝/分/負）＞
        //         対 [1]        対 [2]        対 [3]          [total]
