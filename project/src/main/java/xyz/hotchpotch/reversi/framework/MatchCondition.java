...
public class MatchCondition implements Condition<Match>, Serializable {
     ...
     *   <tr><td>{@code player.a}</td><td>プレーヤーAの完全修飾クラス名</td><td>{@code xyz.hotchpotch.reversi.aiplayers.SimplestAIPlayer}</td></tr>
     *   <tr><td>{@code player.b}</td><td>プレーヤーBの完全修飾クラス名</td><td>{@code xyz.hotchpotch.reversi.aiplayers.RandomAIPlayer}</td></tr>
